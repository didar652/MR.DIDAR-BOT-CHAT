...
module.exports = {
  ...
  if (args.length === 0) {
      ...
      msg += `𝗧𝘆𝗽𝗲 ${prefix}𝗵𝗲𝗹𝗽 [DIDAR-𝗕𝗢𝗧] 𝘁𝗼 𝘃𝗶𝗲𝘄 𝘁𝗵𝗲 𝗱𝗲𝘁𝗮𝗶𝗹𝘀 𝗼𝗳 𝘁𝗵𝗮𝘁 𝗰𝗼𝗺𝗺𝗮𝗻𝗱\n`;
      msg += `🌟 | DIDAR-𝗕𝗢𝗧 `;


      const helpListImages = [
        "https://i.postimg.cc/tR3p7cnd/undefined-Imgur.jpg", // add image link here
        "https://i.postimg.cc/tR3p7cnd/undefined-Imgur.jpg",
        "https://i.postimg.cc/tR3p7cnd/undefined-Imgur.jpg",
        "https://i.postimg.cc/tR3p7cnd/undefined-Imgur.jpg",
        "https://i.postimg.cc/tR3p7cnd/undefined-Imgur.jpg",
